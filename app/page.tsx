...
export default async function Home() {
  const [homePage, caseStudies] = await Promise.all([
    client.fetch<SanityHomePage | null>(HOME_PAGE_QUERY, {}, { cache: "force-cache", next: { tags: ["sanity"] } }),
    client.fetch<SanityCaseStudy[]>(CASE_STUDIES_QUERY, {}, { cache: "force-cache", next: { tags: ["sanity"] } }),
  ]);
