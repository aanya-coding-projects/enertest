...
export async function POST(req: NextRequest) {
  try {
    ...
    const { name, company, email, phone, subject, message, turnstileToken } = body;
    ...
    await Promise.all([
      resend.emails.send({
        ...
        to: salesEmails,
        subject: `New Contact Message — ${eSubject || "General Inquiry"} (${eName})`,
        html: `
          <div style="font-family:sans-serif;max-width:600px;margin:0 auto;color:#1a1a1a">
            ...
            <div style="background:#f9f9f9;padding:32px;border-radius:0 0 8px 8px;border:1px solid #e5e5e5">
              ...
              <table style="width:100%;border-collapse:collapse;font-size:14px">
                ...
                <tr><td style="padding:6px 0;color:#555">Subject</td><td style="padding:6px 0">${eSubject || "—"}</td></tr>
              </table>
